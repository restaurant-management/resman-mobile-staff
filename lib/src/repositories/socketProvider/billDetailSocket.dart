...
class BillDetailSocket {
  static BillDetailSocket _singleton;

  static BillDetailSocket get instance {
    if (_singleton == null) {
      print('Initialize StaffSocket ...');
      _singleton = BillDetailSocket._internal();
    }
    return _singleton;
  }

  factory BillDetailSocket() {
    return instance;
  }

  BillDetailSocket._internal();


  Socket socket;
  Socket billDetailSocket;

  Future<void> InitConnect(int billId) async {
